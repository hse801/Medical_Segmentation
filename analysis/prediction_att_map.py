...
Prediction code for generated attenuation map
with 1 input channel and 1 class
save metrics in.csv file

Also create nii file of the prediction image

Copied from prediction_thyroid.py
...
csv_name = 'prediction_att_map.csv'
