...
# from .CoLearning import YNet, init
...
model_list = ['UNET3D', 'DENSENET1', "UNET2D", 'DENSENET2', 'DENSENET3', 'HYPERDENSENET', "SKIPDENSENET3D",
              ...
              "DEEPMEDIC", "RESUNETOGL", "RESUNETOGT", "COLEARN"]
...
def create_model(args):
    ...
    if model_name == 'VNET2':
        ...
        model = UNet3D(in_channels=in_channels, n_classes=num_classes, base_n_filter=4)
