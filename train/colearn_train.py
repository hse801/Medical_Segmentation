...
def main():
    ...
    train_generator, val_generator, _ = medical_loaders.lung_dataloader.generate_lung_dataset()
...
def get_arguments():
    ...
    parser.add_argument('--dataset_name', type=str, default="lung")
    parser.add_argument('--dim', nargs="+", type=int, default=(80, 128, 160))
    ...
    parser.add_argument('--model', type=str, default='UNET3D',
                        choices=('VNET', 'VNET2', 'UNET3D', 'DENSENET1', 'DENSENET2', 'DENSENET3', 'HYPERDENSENET',
                                 ...
                                 'RESUNETKIDNEY', 'CONRESNET', 'DEEPMEDIC', 'RESUNETOGT', 'RESUNETOGL', 'COLEARN'))
