...
for f in file_path:
    ...
    # interp_img(src_file=ct_nii[0], dst_file='CT_rsmpl.nii.gz', ref_file=mask_nii[0])
    # interp_img(src_file=spect_nii[0], dst_file='SPECT_rsmpl.nii.gz', ref_file=mask_nii[0])
