...
# def run_prediction(valid_path, model_path, ):
#     model = load_model(model_path)

# def disp_prediction(output):
...
def predictor(PATH, data_loader):
    ...
    model = medzoo.UNet3D(in_channels=1, n_classes=1, base_n_filter=8)
    checkpoint = torch.load(model_path)
    ...
    for batch_idx, input_tuple in enumerate(data_loader):
        with torch.no_grad():
            ...
            os.chdir('E:/HSE/Medical_Segmentation/saved_models/UNET3D_checkpoints/UNET3D_29_06___17_24_thyroid_/prediction/')
            # os.mkdir('prediction/')
...
train_loader, valid_loader = dataloaders.thyroid_dataloader.generate_thyroid_dataset()
PATH = 'E:/HSE/Medical_Segmentation/saved_models/UNET3D_checkpoints/'
# model_path = PATH + 'UNET3D_29_06___17_24_thyroid_/UNET3D_29_06___17_24_thyroid__BEST.pth'
# model_path = PATH + 'UNET3D_29_06___17_24_thyroid_/UNET3D_29_06___17_24_thyroid__last_epoch.pth'

predictor(PATH=PATH, data_loader=valid_loader)
